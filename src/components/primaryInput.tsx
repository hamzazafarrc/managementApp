...
const PrimaryInput = (props: primaryInputPros) => {
    ...
    return (
        <View style={[styles.main, props.containerStyles]}>
            ...
            {/* TEXT INPUT */}
            <View style={[styles.container, props.inputContainer, { borderColor: props?.isError ? COLORS.SECONDARY_1 : COLORS.PRIMARY_1 }]}>
                <TextInput
                    ref={props.inputRef}
                    style={[
                        styles.input,
                    ...
                    >
                        {
                            props?.renderRightIcon ?
                                props?.renderRightIcon :
                                <Feather name={props?.iconName ? props?.iconName : isSecureTextEntry ? 'eye' : 'eye-off'} color={COLORS.PRIMARY_1} size={21} />
...
const styles = StyleSheet.create({
    ...
    titleContainer: {
        ...
        marginStart: wp(5), // How far right do you want the label to start
